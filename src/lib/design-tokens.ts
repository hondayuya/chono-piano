...
export const typeTokens: TypeToken[] = [
  {
    ...
    sample: 'チョウノウ調律所',
    preview: 'brand',
    specs: 'A1明朝 → Shippori Mincho / weight 500 / letter-spacing 0.08em',
    role: 'ヘッダーのサイト名',
  },
  {
    name: 'Display',
    ...
    sample: 'あなたの演奏\n調律で損をして\nいませんか？',
    preview: 'display',
    specs: 'A1明朝 → Shippori Mincho / weight 500 / palt（font-feature-settings） / letter-spacing 0.04–0.08em',
    role: '見出し・キャッチ',
  },
  {
    name: 'Body',
    ...
    preview: 'body',
    specs: '中ゴシックBBB → Zen Kaku Gothic New / weight 400 / line-height 1.75 / 1.6rem（html 11px）',
    role: '本文・UI テキスト',
  },
  {
    name: 'Section title',
